      ...
      <main className="relative px-6 pt-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex h-9 items-center gap-2 rounded-full bg-gradient-to-br from-blue-700 to-red-700  px-4 text-sm text-white">
              <svg
                className="h-4 w-4"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <span className="block text-xl font-semibold mt-3 bg-blue-500 bg-clip-text text-transparent">
              Your Safety is Our Priority
            </span>

            <p className="mt-6 max-w-2xl text-md leading-relaxed text-zinc-400">
          ...
          <div className="mt-24 grid gap-12">
            {[
              ...
              >
                <div className="absolute inset-0  bg-gradient-to-br from-blue-400/10 to-red-400/10 opacity-50 transition-opacity group-hover:opacity-100" />
                <div className="relative flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-red-600 to-blue-600">
                      {step.icon}
                    </div>
                  </div>
                  <div>
              ...
              {[
                {
                  ...
                  icon: <SiLetsencrypt className="text-white text-2xl" />,
                },
                {
                  title: 'No Logs Policy',
                  description: 'We never store IP addresses or user metadata',
                  icon: <IoShieldCheckmark className="text-white text-2xl" />,
                },
                {
                  title: 'Regular Audits',
                  description: 'Independent security firms verify our systems',
                  icon: <MdNoteAlt className="text-white text-2xl" />,
                },
              ].map((feature, i) => (
          ...
          <div className="mt-24 mb-20 text-center">
            <Link href={'/submit-report'}>
              <button className="group relative inline-flex h-12 items-center justify-center gap-2 rounded-3xl border bg-transparent px-8 text-sm font-medium text-white transition-all hover:text-blue-400 hover:border-blue-400">
